...
You can take an instance of the class `APIData` or a collection of several
`APIData.long()` lazyframes `pl.concat()` together and conver them into
a star model with an in-memory "fact" table and "dimensions".
